 ...
 */
final class Version20201104145432 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD id_categorie_id INT NOT NULL, ADD libelle VARCHAR(255) NOT NULL, ADD tarif DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP id_categorie_id, DROP libelle, DROP tarif');
    }
}
